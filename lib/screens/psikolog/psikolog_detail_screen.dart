...
/// Screen Detail Psikolog
class PsikologDetailScreen extends StatefulWidget {
  final int psikologId;

  const PsikologDetailScreen({super.key, required this.psikologId});

  @override
  State<PsikologDetailScreen> createState() => _PsikologDetailScreenState();
}

class _PsikologDetailScreenState extends State<PsikologDetailScreen> {
  @override
  void initState() {
    super.initState();
